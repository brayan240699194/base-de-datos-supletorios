...
public class FrmListaReproduccion1 extends javax.swing.JInternalFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        pBuscar.add(rbtNombreLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, -1, -1));
        ...
        pBuscar.add(txtBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 51, 420, -1));
        ...
        pBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 430, 360));

        buttonGroup1.add(rbtusuario);
        rbtusuario.setText("usuario");
        pBuscar.add(rbtusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, -1));
        ...
        pNuevo.add(txtIdLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 80, -1));

        lblNombre.setText("Nombre");
        pNuevo.add(lblNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, -1, -1));
        pNuevo.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 270, -1));

        jLabel3.setText("IdUsuario");
        pNuevo.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, -1, -1));
        pNuevo.add(txtUsuario_idusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 80, -1));

        tablista.addTab("Nuevo/Modificar", pNuevo);

        getContentPane().add(tablista);
        tablista.setBounds(10, 40, 480, 320);
        ...
        btnNuevo.setBounds(510, 100, 130, 30);
        ...
        btnGuardar.setBounds(510, 140, 130, 30);
        ...
        btnModificar.setBounds(510, 180, 130, 30);
        ...
        btnCancelar.setBounds(510, 220, 130, 30);
        ...
        btnSalir.setBounds(510, 260, 130, 30);
        ...
        jLabel1.setBounds(510, 60, 130, 30);
