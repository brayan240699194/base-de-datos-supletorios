...
public class FrmCancion extends javax.swing.JInternalFrame {
   ...
   //--------------------PRESENTACION DE JTABLE----------------------
    ...
    private void initComponents() {
        ...
        pBuscar.setBackground(new java.awt.Color(0, 204, 204));
        ...
        pBuscar.add(rbtnGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 100, -1));

        rbtnAutor.setText("Autor");
        pBuscar.add(rbtnAutor, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, -1, -1));

        rbtnTitulo.setText("Titulo");
        pBuscar.add(rbtnTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, -1, -1));
        ...
        pBuscar.add(txtBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 51, 290, -1));
        ...
        pBuscar.add(rbtnUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, -1, -1));

        tabCancion.addTab("Buscar", pBuscar);

        pNuevo.setBackground(new java.awt.Color(0, 204, 204));
        ...
        pNuevo.add(txtIdCancion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 60, -1));
        ...
        pNuevo.add(txtGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 190, -1));
        pNuevo.add(txtAutor, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 190, -1));
        pNuevo.add(txtTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 190, -1));
        ...
        pNuevo.add(txtDuracion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 80, -1));

        txtFecha.setDateFormatString("yyyy/MM/dd"); // NOI18N
        txtFecha.setMaxSelectableDate(new java.util.Date(253370786519000L));
        pNuevo.add(txtFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, -1, -1));
        pNuevo.add(txtUsuario_idusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 50, -1));

        tabCancion.addTab("Nuevo/Modificar", pNuevo);

        getContentPane().add(tabCancion);
        tabCancion.setBounds(10, 40, 530, 290);
        tabCancion.getAccessibleContext().setAccessibleName("Buscar");

        btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/add_icon-icons.com_74429.png"))); // NOI18N
        ...
        btnNuevo.setBounds(560, 100, 130, 30);

        btnGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/downloads_folder_20356.png"))); // NOI18N
        ...
        btnGuardar.setBounds(560, 140, 130, 30);

        btnModificar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/document_write_22637.png"))); // NOI18N
        ...
        btnModificar.setBounds(560, 180, 130, 30);

        btnCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cancel_27012.png"))); // NOI18N
        ...
        btnCancelar.setBounds(560, 220, 129, 30);

        btnSalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/principal.png"))); // NOI18N
        ...
        btnSalir.setBounds(560, 260, 130, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Applications_Cascade_26977.png"))); // NOI18N
        jLabel1.setText("Controles");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(560, 50, 130, 40);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/3d_music_folder_20526.png"))); // NOI18N
        getContentPane().add(jLabel4);
        jLabel4.setBounds(10, 0, 40, 40);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 204, 204));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/1458264592_laptop_computer_pc_device_notebook_netbook_internet_icon-icons.com_55334.png"))); // NOI18N
        jLabel5.setText("Aplicación Música ");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(200, 0, 210, 40);
